...
## Exercise
We will search the yeast genome with a profile of P53 gene. Yeast is known not to have P53, but still we will see what we get. 
...
hmmsearch -o hits.txt ../p53.hmm sc.fas
```
Indeed looks like there is not hit for P53 in yeast. 
